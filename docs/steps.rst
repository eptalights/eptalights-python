...
Data model or structure for steps - :class:`~eptalights.models.sophia_ir.function.SophiaIRNopModel` :class:`~eptalights.models.sophia_ir.function.SophiaIRAssignModel` :class:`~eptalights.models.sophia_ir.function.SophiaIRCallModel` :class:`~eptalights.models.sophia_ir.function.SophiaIRCondModel` :class:`~eptalights.models.sophia_ir.function.SophiaIRReturnModel` :class:`~eptalights.models.sophia_ir.function.SophiaIRGotoModel` :class:`~eptalights.models.sophia_ir.function.SophiaIRSwitchModel`
