...
Everything concerning variables of a function is managed through the function's ``variable_manager`` which is a :class:`~eptalights.models.sophia_ir.variable.VariableManagerModel` data model.

Data model or structure for variables - :class:`~eptalights.models.sophia_ir.variable.VariableManagerModel` :class:`~eptalights.models.sophia_ir.variable.VariableModel` :class:`~eptalights.models.sophia_ir.variable.SSAVariableModel`
