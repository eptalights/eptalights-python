...
.. code-block:: python
	...
	# output
	"""
	operand=p, operand_type=<class 'eptalights.models.sophia_ir.tokenized_operand.TokenizedOperandModel'>
	"""
...
Each token is an instance of the :class:`~eptalights.models.sophia_ir.tokenized_operand.TokenModel`. Important fields include:
...
- **`token_type`**: The type of token, defined in :class:`~eptalights.models.sophia_ir.enum_types.TokenType`. This can represent symbols, variables, constants, or attributes (in the case of structs).
