...
Data model or structure for callsite - :class:`~eptalights.models.sophia_ir.callsite.CallsiteModel` :class:`~eptalights.models.sophia_ir.callsite.CallsiteManagerModel`
...
5. get total callsites
----------------------

Get total number of callsites in database.

.. code-block:: python
	
	print("total_callsites =", api.get_total_callsites())

	# output
	"""
	total_callsites = 325452
	"""
